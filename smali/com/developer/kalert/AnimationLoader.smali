...
.method private static createAnimationFromXml(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Animation;
    ...
    invoke-static {p0, p1, v0, v1}, Lcom/developer/kalert/AnimationLoader;
    ->createAnimationFromXml(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/animation/AnimationSet;Landroid/util/AttributeSet;)Landroid/view/animation/Animation;
...
.method private static createAnimationFromXml(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/animation/AnimationSet;Landroid/util/AttributeSet;)Landroid/view/animation/Animation;
    ...
    .line 6
    :try_start_0
    invoke-static {v5}, Ljava/lang/Class;
    ...
    invoke-virtual {v5, v6}, Ljava/lang/reflect/Constructor;
    ...
    invoke-direct {p2, p0}, Ljava/lang/RuntimeException;
    -><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v5, p0, p3}, Landroid/view/animation/TranslateAnimation;
    ...
    invoke-direct {v5, p0, p3}, Landroid/view/animation/ScaleAnimation;
    -><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v5, p0, p3}, Landroid/view/animation/AlphaAnimation;
    -><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v5, p0, p3}, Landroid/view/animation/AnimationSet;
    -><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    .line 12
    invoke-static {p0, p1, v5, p3}, Lcom/developer/kalert/AnimationLoader;
    ->createAnimationFromXml(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/animation/AnimationSet;Landroid/util/AttributeSet;)Landroid/view/animation/Animation;
    ...
    invoke-direct {v5, p0, p3}, Landroid/view/animation/RotateAnimation;
    -><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 14
    invoke-virtual {p2, v5}, Landroid/view/animation/AnimationSet;
...
.method public static loadAnimation(Landroid/content/Context;I)Landroid/view/animation/Animation;
    ...
    .line 9
    :try_start_1
    invoke-static {p0, v0}, Lcom/developer/kalert/AnimationLoader;
    ->createAnimationFromXml(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)Landroid/view/animation/Animation;
    ...
    .line 15
    :try_start_2
    invoke-interface {v0}, Landroid/content/res/XmlResourceParser;
    ->close()V
    :try_end_2
    ...
    .line 64
    invoke-static {p1, p0}, Landroidx/core/os/a;
    ->f(Ljava/lang/String;Ljava/lang/Exception;)Landroid/content/res/Resources$NotFoundException;
