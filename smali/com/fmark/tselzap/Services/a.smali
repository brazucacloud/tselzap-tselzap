.class public abstract synthetic Lcom/fmark/tselzap/Services/a;
...
.method public static bridge synthetic A(Landroid/content/pm/PackageManager;Ljava/lang/String;)Z
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroid/content/pm/PackageManager;
    ->isInstantApp(Ljava/lang/String;)Z
...
.method public static synthetic B()Landroid/app/NotificationChannel;
    ...
    const-string v2, "Background Service"

    const/4 v3, 0x0

    invoke-direct {v0, v1, v2, v3}, Landroid/app/NotificationChannel;
...
.method public static synthetic C(Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-direct {v0, v1, p0, v2}, Landroid/app/NotificationChannel;
    -><init>(Ljava/lang/String;Ljava/lang/CharSequence;I)V
return-object v0
.end method
...
.method public static bridge synthetic D(Landroid/app/NotificationChannel;)V
    ...
    invoke-virtual {p0, v0}, Landroid/app/NotificationChannel;
...
.method public static synthetic d()Landroid/app/NotificationChannel;
    ...
    const-string v2, "Example Service Channel"
...
.method public static bridge synthetic l(Ljava/time/LocalDateTime;)Ljava/lang/String;
    ...
    .line 1
    sget-object v0, Ljava/time/format/DateTimeFormatter;
    ->ISO_LOCAL_DATE:Ljava/time/format/DateTimeFormatter;

    invoke-virtual {p0, v0}, Ljava/time/LocalDateTime;
    ->format(Ljava/time/format/DateTimeFormatter;)Ljava/lang/String;
...
.method public static bridge synthetic m()Ljava/time/Duration;
    ...
    invoke-static {v0, v1}, Ljava/time/Duration;
...
.method public static bridge synthetic n(JJ)Ljava/time/Instant;
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Ljava/time/Instant;
...
.method public static bridge synthetic p(Ljava/time/OffsetDateTime;)Ljava/time/LocalDateTime;
    ...
    .line 1
    invoke-virtual {p0}, Ljava/time/OffsetDateTime;
...
.method public static bridge synthetic q(Ljava/time/Instant;)Ljava/time/OffsetDateTime;
    ...
    .line 1
    sget-object v0, Ljava/time/ZoneOffset;
    ->UTC:Ljava/time/ZoneOffset;

    invoke-virtual {p0, v0}, Ljava/time/Instant;
