...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->context:Landroid/content/Context;

    const/4 v0, 0x0
    iput-boolean v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->isConnected:Z

    # Initialize OkHttpClient
    new-instance v1, Lokhttp3/OkHttpClient$Builder;
    invoke-direct {v1}, Lokhttp3/OkHttpClient$Builder;
    -><init>()V
    invoke-virtual {v1}, Lokhttp3/OkHttpClient$Builder;
    ->build()Lokhttp3/OkHttpClient;
    move-result-object v1
    iput-object v1, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ...
    iput-object v1, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->heartbeatHandler:Landroid/os/Handler;

    # Initialize heartbeat runnable
    new-instance v0, Lcom/fmark/tselzap/Services/WebSocketManager$1;
    invoke-direct {v0, p0}, Lcom/fmark/tselzap/Services/WebSocketManager$1;
    -><init>(Lcom/fmark/tselzap/Services/WebSocketManager;)V
    iput-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->heartbeatRunnable:Ljava/lang/Runnable;
...
.method public static getInstance(Landroid/content/Context;)Lcom/fmark/tselzap/Services/WebSocketManager;
    ...
    sget-object v0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->instance:Lcom/fmark/tselzap/Services/WebSocketManager;
    if-nez v0, :cond_0

    new-instance v0, Lcom/fmark/tselzap/Services/WebSocketManager;
    invoke-direct {v0, p0}, Lcom/fmark/tselzap/Services/WebSocketManager;
    -><init>(Landroid/content/Context;)V
    sput-object v0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->instance:Lcom/fmark/tselzap/Services/WebSocketManager;
...
.method public connect()V
    ...
    invoke-direct {v1}, Lokhttp3/Request$Builder;
    -><init>()V
    const-string v2, "ws://172.31.47.244:3000"
    invoke-virtual {v1, v2}, Lokhttp3/Request$Builder;
    ->url(Ljava/lang/String;)Lokhttp3/Request$Builder;
    move-result-object v1
    invoke-virtual {v1}, Lokhttp3/Request$Builder;
    ->build()Lokhttp3/Request;
    move-result-object v1

    # Create WebSocket listener
    new-instance v2, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    invoke-direct {v2, p0}, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    -><init>(Lcom/fmark/tselzap/Services/WebSocketManager;)V

    # Connect WebSocket
    iget-object v3, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->client:Lokhttp3/OkHttpClient;
    invoke-virtual {v3, v1, v2}, Lokhttp3/OkHttpClient;
    ->newWebSocket(Lokhttp3/Request;Lokhttp3/WebSocketListener;)Lokhttp3/WebSocket;
    move-result-object v1
    iput-object v1, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->webSocket:Lokhttp3/WebSocket;
...
.method public disconnect()V
    ...
    iget-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->webSocket:Lokhttp3/WebSocket;
    if-eqz v0, :cond_0

    const/16 v1, 0x3e8
    const-string v2, "App closing"
    invoke-interface {v0, v1, v2}, Lokhttp3/WebSocket;
    ...
    # Stop heartbeat
    invoke-direct {p0}, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->stopHeartbeat()V
    return-void
.end method
...
.method public registerDevice()V
    ...
    sget-object v2, Landroid/os/Build$VERSION;
    ...
    invoke-virtual {v1, v2}, Lorg/json/JSONArray;
    ...
    :catch_0
    move-exception v1
    invoke-virtual {v1}, Lorg/json/JSONException;
    ->printStackTrace()V
    ...
    move-result-object v0
    invoke-direct {p0, v1, v0}, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->emitEvent(Ljava/lang/String;Ljava/lang/String;)V
    return-void
.end method
...
.method private emitEvent(Ljava/lang/String;Ljava/lang/String;)V
    ...
    ->webSocket:Lokhttp3/WebSocket;
    if-eqz v0, :cond_0
    iget-boolean v1, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->isConnected:Z
    if-eqz v1, :cond_0
...
.method private startHeartbeat()V
    ...
    iget-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->heartbeatHandler:Landroid/os/Handler;
    iget-object v1, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->heartbeatRunnable:Ljava/lang/Runnable;
...
.method private sendHeartbeat()V
    ...
    -><init>()V
    invoke-virtual {v2}, Ljava/util/Date;
    ->toString()Ljava/lang/String;
    move-result-object v2
    invoke-virtual {v0, v1, v2}, Lorg/json/JSONObject;
    ->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
...
.method public sendTaskStarted(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1, p1}, Lorg/json/JSONObject;
    ->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
...
.method public sendTaskCompleted(Ljava/lang/String;ZLjava/lang/String;)V
    ...
    invoke-virtual {v1, v2, p2}, Lorg/json/JSONObject;
    ->put(Ljava/lang/String;Z)Lorg/json/JSONObject;
    const-string v2, "message"
    invoke-virtual {v1, v2, p3}, Lorg/json/JSONObject;
    ->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    const-string v2, "execution_time"
    const-string v3, "5.2s"
    invoke-virtual {v1, v2, v3}, Lorg/json/JSONObject;
    ->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
...
.method public sendWhatsAppMessageSent(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v1, p2}, Lorg/json/JSONObject;
    ->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    const-string v1, "success"
    invoke-virtual {v0, v1, p3}, Lorg/json/JSONObject;
    ->put(Ljava/lang/String;Z)Lorg/json/JSONObject;
...
.method public setAccessibilityService(Lcom/fmark/tselzap/Services/AcessibilityService;)V
    ...
    iput-object p1, p0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->accessibilityService:Lcom/fmark/tselzap/Services/AcessibilityService;
...
.method constructor <init>(Lcom/fmark/tselzap/Services/WebSocketManager;)V
    ...
    iput-object p1, p0, Lcom/fmark/tselzap/Services/WebSocketManager$1;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    invoke-direct {p0}, Ljava/lang/Object;
    -><init>()V
    return-void
.end method
...
.method public run()V
    ...
    # Send heartbeat
    iget-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager$1;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    invoke-direct {v0}, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->sendHeartbeat()V

    # Schedule next heartbeat
    iget-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager$1;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    iget-object v0, v0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->heartbeatHandler:Landroid/os/Handler;
...
.method constructor <init>(Lcom/fmark/tselzap/Services/WebSocketManager;)V
    ...
    iput-object p1, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    invoke-direct {p0}, Lokhttp3/WebSocketListener;
    -><init>()V
    return-void
.end method
...
.method public onOpen(Lokhttp3/WebSocket;Lokhttp3/Response;)V
    ...
    iget-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    const/4 v1, 0x1
    iput-boolean v1, v0, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->isConnected:Z

    # Send connection acknowledgment
    const-string v1, "40"
    invoke-interface {p1, v1}, Lokhttp3/WebSocket;
    ->send(Ljava/lang/String;)Z
...
.method public onMessage(Lokhttp3/WebSocket;Ljava/lang/String;)V
    ...
    move-result-object v0
    invoke-direct {p0, v0}, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->handleSocketIOEvent(Ljava/lang/String;)V
...
.method public onFailure(Lokhttp3/WebSocket;Ljava/lang/Throwable;Lokhttp3/Response;)V
    ...
    invoke-direct {p3, p0}, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$1;
    -><init>(Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;)V

    const-wide/16 v0, 0x1388
    invoke-virtual {p2, p3, v0, v1}, Landroid/os/Handler;
    ->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private handleSocketIOEvent(Ljava/lang/String;)V
    ...
    const/4 v1, 0x0
    invoke-virtual {v0, v1}, Lorg/json/JSONArray;
    ...
    move-result-object v0
    invoke-direct {p0, v0}, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->handleNewTask(Lorg/json/JSONObject;)V
    goto :goto_0
    ...
    :catch_0
    move-exception v0
    invoke-virtual {v0}, Lorg/json/JSONException;
    ->printStackTrace()V
...
.method private handleNewTask(Lorg/json/JSONObject;)V
    ...
    # Notify task started
    iget-object v3, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    invoke-virtual {v3, v0}, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->sendTaskStarted(Ljava/lang/String;)V

    # Execute task via AccessibilityService
    iget-object v3, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    iget-object v3, v3, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->accessibilityService:Lcom/fmark/tselzap/Services/AcessibilityService;
    if-eqz v3, :cond_0

    # Call accessibility service to execute task
    invoke-virtual {v3, v0, v1, v2}, Lcom/fmark/tselzap/Services/AcessibilityService;
    ->executeWhatsAppTask(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    goto :goto_1
    ...
    ->getMainLooper()Landroid/os/Looper;
    move-result-object v4
    invoke-direct {v3, v4}, Landroid/os/Handler;
    -><init>(Landroid/os/Looper;)V

    new-instance v4, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    invoke-direct {v4, p0, v0, v1, v2}, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    -><init>(Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    const-wide/16 v0, 0xbb8
    invoke-virtual {v3, v4, v0, v1}, Landroid/os/Handler;
    ->postDelayed(Ljava/lang/Runnable;J)Z
    :try_end_0
    .catch Lorg/json/JSONException; {:try_start_0 .. :try_end_0} :catch_0
...
.method constructor <init>(Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    ->this$1:Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    invoke-direct {p0}, Ljava/lang/Object;
    -><init>()V
    iput-object p2, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    ->taskId:Ljava/lang/String;
    iput-object p3, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    ->targetPhone:Ljava/lang/String;
    iput-object p4, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    ->this$1:Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    iget-object v0, v0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    iget-object v1, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    ->targetPhone:Ljava/lang/String;
    iget-object v2, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$TaskCompletionRunnable;
    ->messageText:Ljava/lang/String;
    const/4 v3, 0x1
    invoke-virtual {v0, v1, v2, v3}, Lcom/fmark/tselzap/Services/WebSocketManager;
    ->sendWhatsAppMessageSent(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v1, v3, v2}, Lcom/fmark/tselzap/Services/WebSocketManager;
...
.method constructor <init>(Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;)V
    ...
    iput-object p1, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$1;
    ->this$1:Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    invoke-direct {p0}, Ljava/lang/Object;
    -><init>()V
    return-void
...
.method public run()V
    ...
    iget-object v0, p0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener$1;
    ->this$1:Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    iget-object v0, v0, Lcom/fmark/tselzap/Services/WebSocketManager$WebSocketListener;
    ->this$0:Lcom/fmark/tselzap/Services/WebSocketManager;
    invoke-virtual {v0}, Lcom/fmark/tselzap/Services/WebSocketManager;
