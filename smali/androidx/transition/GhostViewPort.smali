...
.method public constructor <init>(Landroid/view/View;)V
    ...
    .line 5
    invoke-direct {p0, v0}, Landroid/view/ViewGroup;
    ...
    .line 9
    .line 10
    invoke-direct {v0, p0}, Landroidx/transition/GhostViewPort$1;
    -><init>(Landroidx/transition/GhostViewPort;)V

    .line 11
    .line 12
    .line 13
    iput-object v0, p0, Landroidx/transition/GhostViewPort;
    ->mOnPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    .line 14
    .line 15
    iput-object p1, p0, Landroidx/transition/GhostViewPort;
...
.method public static addGhost(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)Landroidx/transition/GhostViewPort;
    ...
    .line 8
    .line 9
    invoke-static {p1}, Landroidx/transition/GhostViewHolder;
    ->getHolder(Landroid/view/ViewGroup;)Landroidx/transition/GhostViewHolder;
    ...
    ->getGhostView(Landroid/view/View;)Landroidx/transition/GhostViewPort;
    ...
    .line 26
    .line 27
    iget v3, v1, Landroidx/transition/GhostViewPort;
    ->mReferences:I
    ...
    ->calculateMatrix(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)V
    ...
    .line 48
    .line 49
    invoke-direct {v1, p0}, Landroidx/transition/GhostViewPort;
    -><init>(Landroid/view/View;)V

    .line 50
    .line 51
    .line 52
    invoke-virtual {v1, p2}, Landroidx/transition/GhostViewPort;
    ...
    .line 58
    .line 59
    invoke-direct {v0, p1}, Landroidx/transition/GhostViewHolder;
    ...
    .line 63
    :cond_2
    invoke-virtual {v0}, Landroidx/transition/GhostViewHolder;
    ->popToOverlayTop()V
    ...
    .line 66
    :goto_1
    invoke-static {p1, v0}, Landroidx/transition/GhostViewPort;
    ->copySize(Landroid/view/View;Landroid/view/View;)V

    .line 67
    .line 68
    .line 69
    invoke-static {p1, v1}, Landroidx/transition/GhostViewPort;
    ->copySize(Landroid/view/View;Landroid/view/View;)V

    .line 70
    .line 71
    .line 72
    invoke-virtual {v0, v1}, Landroidx/transition/GhostViewHolder;
    ->addGhostView(Landroidx/transition/GhostViewPort;)V

    .line 73
    .line 74
    .line 75
    iput v3, v1, Landroidx/transition/GhostViewPort;
    ->mReferences:I
    ...
    :cond_4
    :goto_2
    iget p0, v1, Landroidx/transition/GhostViewPort;
    ->mReferences:I
    ...
    .line 86
    .line 87
    iput p0, v1, Landroidx/transition/GhostViewPort;
    ->mReferences:I    
    return-object v1
...
.method public static calculateMatrix(Landroid/view/View;Landroid/view/ViewGroup;Landroid/graphics/Matrix;)V
    ...
    .line 9
    .line 10
    invoke-static {p0, p2}, Landroidx/transition/ViewUtils;
    ...
    .line 25
    invoke-virtual {p2, v0, p0}, Landroid/graphics/Matrix;
    ->preTranslate(FF)Z
...
.method public static copySize(Landroid/view/View;Landroid/view/View;)V
    ...
    .line 27
    invoke-static {p1, v0, v1, v3, p0}, Landroidx/transition/ViewUtils;
...
.method public static getGhostView(Landroid/view/View;)Landroidx/transition/GhostViewPort;
    ...
    .line 7
    check-cast p0, Landroidx/transition/GhostViewPort;    return-object p0
.end method
...
.method public static removeGhost(Landroid/view/View;)V
    ...
    .line 6
    .line 7
    iget v0, p0, Landroidx/transition/GhostViewPort;
    ->mReferences:I
    ...
    .line 10
    .line 11
    iput v0, p0, Landroidx/transition/GhostViewPort;
    ->mReferences:I
    ...
    .line 20
    .line 21
    invoke-virtual {v0, p0}, Landroid/view/ViewGroup;
    ->removeView(Landroid/view/View;)V
...
.method public onAttachedToWindow()V
    ...
    .line 3
    .line 4
    iget-object v0, p0, Landroidx/transition/GhostViewPort;
    ->mView:Landroid/view/View;

    .line 5
    .line 6
    invoke-static {v0, p0}, Landroidx/transition/GhostViewPort;
    ->setGhostView(Landroid/view/View;Landroidx/transition/GhostViewPort;)V
    ...
    .line 15
    iget-object v1, p0, Landroidx/transition/GhostViewPort;
    ->mOnPreDrawListener:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    .line 23
    invoke-static {v0, v1}, Landroidx/transition/ViewUtils;
...
.method public onDetachedFromWindow()V
    ...
    .line 21
    invoke-static {v0, v1}, Landroidx/transition/GhostViewPort;
    ->setGhostView(Landroid/view/View;Landroidx/transition/GhostViewPort;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 2
    invoke-static {p1, v0}, Landroidx/transition/CanvasUtils;
    ->enableZ(Landroid/graphics/Canvas;Z)V
    ...
    .line 24
    invoke-static {v0, v2}, Landroidx/transition/ViewUtils;
    ->setTransitionVisibility(Landroid/view/View;I)V
    ...
    .line 33
    invoke-virtual {p0, p1, v0, v2, v3}, Landroid/view/ViewGroup;
    ->drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z

    .line 34
    .line 35
    .line 36
    invoke-static {p1, v1}, Landroidx/transition/CanvasUtils;
    ->enableZ(Landroid/graphics/Canvas;Z)V
return-void
.end method
...
.method public reserveEndViewTransition(Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    .line 2
    .line 3
    iput-object p2, p0, Landroidx/transition/GhostViewPort;
...
.method public setVisibility(I)V
    ...
    .line 5
    .line 6
    invoke-static {v0}, Landroidx/transition/GhostViewPort;
    ->getGhostView(Landroid/view/View;)Landroidx/transition/GhostViewPort;
