...
.method static constructor <clinit>()V
    ...
    .line 2
    .line 3
    invoke-direct {v0}, Landroidx/transition/AutoTransition;
    -><init>()V

    .line 4
    .line 5
    .line 6
    sput-object v0, Landroidx/transition/TransitionManager;
    ->sDefaultTransition:Landroidx/transition/Transition;
    ...
    .line 13
    sput-object v0, Landroidx/transition/TransitionManager;
    ->sRunningTransitions:Ljava/lang/ThreadLocal;
    ...
    .line 20
    sput-object v0, Landroidx/transition/TransitionManager;
    ->sPendingTransitions:Ljava/util/ArrayList;    return-void
.end method
...
.method public constructor <init>()V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Landroidx/transition/TransitionManager;
    ->mSceneTransitions:Landroidx/collection/ArrayMap;
    ...
    .line 16
    iput-object v0, p0, Landroidx/transition/TransitionManager;
    ->mScenePairTransitions:Landroidx/collection/ArrayMap;    
    return-void
.end method
...
.method public static beginDelayedTransition(Landroid/view/ViewGroup;)V
    ...
    .line 1
    invoke-static {p0, v0}, Landroidx/transition/TransitionManager;
...
.method public static beginDelayedTransition(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    .line 2
    sget-object v0, Landroidx/transition/TransitionManager;
    ...
    .line 4
    sget-object p1, Landroidx/transition/TransitionManager;
    ->sDefaultTransition:Landroidx/transition/Transition;
    ...
    .line 6
    invoke-static {p0, p1}, Landroidx/transition/TransitionManager;
    ->sceneChangeSetup(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V

    const/4 v0, 0x0

    .line 7
    invoke-static {p0, v0}, Landroidx/transition/Scene;
    ->setCurrentScene(Landroid/view/ViewGroup;Landroidx/transition/Scene;)V

    .line 8
    invoke-static {p0, p1}, Landroidx/transition/TransitionManager;
    ->sceneChangeRunTransition(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method private static changeScene(Landroidx/transition/Scene;Landroidx/transition/Transition;)V
    ...
    .line 5
    sget-object v1, Landroidx/transition/TransitionManager;
    ->sPendingTransitions:Ljava/util/ArrayList;
    ...
    .line 20
    .line 21
    invoke-virtual {v1}, Landroidx/transition/Scene;
    ->exit()V
    ...
    .line 28
    :cond_1
    sget-object v2, Landroidx/transition/TransitionManager;
    ->sPendingTransitions:Ljava/util/ArrayList;
    ...
    .line 46
    invoke-virtual {p1, v1}, Landroidx/transition/Transition;
...
.method public static controlDelayedTransition(Landroid/view/ViewGroup;Landroidx/transition/Transition;)Landroidx/transition/TransitionSeekController;
    ...
    .line 48
    .line 49
    invoke-static {p0, v1}, Landroidx/transition/Scene;
    ->setCurrentScene(Landroid/view/ViewGroup;Landroidx/transition/Scene;)V
    ...
    ->createSeekController()Landroidx/transition/TransitionSeekController;
...
.method public static createSeekController(Landroidx/transition/Scene;Landroidx/transition/Transition;)Landroidx/transition/TransitionSeekController;
    ...
    .line 18
    if-eqz v1, :cond_0    return-object v2
    ...
    .line 48
    .line 49
    invoke-direct {v2}, Landroidx/transition/TransitionSet;
    -><init>()V

    .line 50
    .line 51
    .line 52
    invoke-virtual {v2, p1}, Landroidx/transition/TransitionSet;
    ->addTransition(Landroidx/transition/Transition;)Landroidx/transition/TransitionSet;
    ...
    .line 67
    :cond_2
    invoke-static {v0, v2}, Landroidx/transition/TransitionManager;
    ->sceneChangeSetup(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
...
.method public static endTransitions(Landroid/view/ViewGroup;)V
    ...
    .line 5
    .line 6
    invoke-static {}, Landroidx/transition/TransitionManager;
    ->getRunningTransitions()Landroidx/collection/ArrayMap;
    ...
    .line 10
    invoke-virtual {v0, p0}, Landroidx/collection/ArrayMap;
    ...
    .line 42
    .line 43
    invoke-virtual {v2, p0}, Landroidx/transition/Transition;
...
.method public static getRunningTransitions()Landroidx/collection/ArrayMap;
    ...
    .line 31
    .line 32
    invoke-virtual {v2, v1}, Ljava/lang/ThreadLocal;
...
.method private getTransition(Landroidx/transition/Scene;)Landroidx/transition/Transition;
    ...
    .line 1
    invoke-virtual {p1}, Landroidx/transition/Scene;
    ->getSceneRoot()Landroid/view/ViewGroup;
    ...
    .line 10
    .line 11
    iget-object v1, p0, Landroidx/transition/TransitionManager;
    ->mScenePairTransitions:Landroidx/collection/ArrayMap;
    ...
    .line 20
    .line 21
    invoke-virtual {v1, v0}, Landroidx/collection/ArrayMap;
    ->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 30
    :cond_0
    iget-object v0, p0, Landroidx/transition/TransitionManager;
    ->mSceneTransitions:Landroidx/collection/ArrayMap;
    ...
    :cond_1
    sget-object p1, Landroidx/transition/TransitionManager;
    ->sDefaultTransition:Landroidx/transition/Transition;    return-object p1
.end method
...
.method public static go(Landroidx/transition/Scene;)V
    ...
    invoke-static {p0, v0}, Landroidx/transition/TransitionManager;
    ->changeScene(Landroidx/transition/Scene;Landroidx/transition/Transition;)V
return-void
.end method
...
.method private static sceneChangeRunTransition(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1, p0}, Landroidx/transition/TransitionManager$MultiListener;
    -><init>(Landroidx/transition/Transition;Landroid/view/ViewGroup;)V
    ...
    .line 17
    invoke-virtual {p0, v0}, Landroid/view/ViewTreeObserver;
...
.method private static sceneChangeSetup(Landroid/view/ViewGroup;Landroidx/transition/Transition;)V
    ...
    .line 34
    .line 35
    invoke-virtual {v1, p0}, Landroidx/transition/Transition;
    ...
    .line 42
    invoke-virtual {p1, p0, v0}, Landroidx/transition/Transition;
    ...
    .line 45
    :cond_1
    invoke-static {p0}, Landroidx/transition/Scene;
    ->getCurrentScene(Landroid/view/ViewGroup;)Landroidx/transition/Scene;
...
.method public setTransition(Landroidx/transition/Scene;Landroidx/transition/Scene;Landroidx/transition/Transition;)V
    ...
    invoke-virtual {v0, p2}, Landroidx/collection/ArrayMap;
    ->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 5
    :cond_0
    invoke-virtual {v0, p1, p3}, Landroidx/collection/SimpleArrayMap;
    ->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public transitionTo(Landroidx/transition/Scene;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/transition/TransitionManager;
    ->getTransition(Landroidx/transition/Scene;)Landroidx/transition/Transition;
    ...
    .line 5
    invoke-static {p1, v0}, Landroidx/transition/TransitionManager;
    ->changeScene(Landroidx/transition/Scene;Landroidx/transition/Transition;)V
return-void
.end method
