...
.method public constructor <init>(Landroidx/preference/PreferenceGroup;)V
    ...
    .line 5
    .line 6
    invoke-direct {v0, p0}, Landroidx/preference/PreferenceGroupAdapter$1;
    -><init>(Landroidx/preference/PreferenceGroupAdapter;)V

    .line 7
    .line 8
    .line 9
    iput-object v0, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mSyncRunnable:Ljava/lang/Runnable;

    .line 10
    .line 11
    iput-object p1, p0, Landroidx/preference/PreferenceGroupAdapter;
    ...
    .line 23
    .line 24
    invoke-virtual {p1, p0}, Landroidx/preference/Preference;
    ->setOnPreferenceChangeInternalListener(Landroidx/preference/Preference$OnPreferenceChangeInternalListener;)V
    ...
    .line 39
    iput-object v0, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mVisiblePreferences:Ljava/util/List;
    ...
    .line 46
    iput-object v0, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mPreferenceResourceDescriptors:Ljava/util/List;
    ...
    .line 53
    .line 54
    invoke-virtual {p1}, Landroidx/preference/PreferenceScreen;
    ->shouldUseGeneratedIds()Z
    ...
    .line 66
    :goto_0
    invoke-virtual {p0}, Landroidx/preference/PreferenceGroupAdapter;
    ->updatePreferences()V
    return-void
.end method
...
.method private createExpandButton(Landroidx/preference/PreferenceGroup;Ljava/util/List;)Landroidx/preference/ExpandButton;
    ...
    .line 11
    invoke-direct {v0, v1, p2, v2, v3}, Landroidx/preference/ExpandButton;
    -><init>(Landroid/content/Context;Ljava/util/List;J)V
    ...
    .line 15
    .line 16
    invoke-direct {p2, p0, p1}, Landroidx/preference/PreferenceGroupAdapter$3;
    -><init>(Landroidx/preference/PreferenceGroupAdapter;Landroidx/preference/PreferenceGroup;)V

    .line 17
    .line 18
    .line 19
    invoke-virtual {v0, p2}, Landroidx/preference/Preference;
...
.method private createVisiblePreferencesList(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    .line 10
    .line 11
    invoke-virtual {p1}, Landroidx/preference/PreferenceGroup;
    ...
    .line 18
    .line 19
    invoke-virtual {p1, v3}, Landroidx/preference/PreferenceGroup;
    ...
    .line 23
    invoke-virtual {v5}, Landroidx/preference/Preference;
    ->isVisible()Z
    ...
    .line 31
    :cond_0
    invoke-direct {p0, p1}, Landroidx/preference/PreferenceGroupAdapter;
    ->isGroupExpandable(Landroidx/preference/PreferenceGroup;)Z
    ...
    .line 37
    invoke-virtual {p1}, Landroidx/preference/PreferenceGroup;
    ->getInitialExpandedChildrenCount()I
    ...
    .line 59
    .line 60
    invoke-virtual {v5}, Landroidx/preference/PreferenceGroup;
    ...
    .line 72
    .line 73
    invoke-direct {p0, v5}, Landroidx/preference/PreferenceGroupAdapter;
    ->isGroupExpandable(Landroidx/preference/PreferenceGroup;)Z
    ...
    :goto_3
    invoke-direct {p0, v5}, Landroidx/preference/PreferenceGroupAdapter;
    ->createVisiblePreferencesList(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    .line 145
    .line 146
    invoke-direct {p0, p1, v1}, Landroidx/preference/PreferenceGroupAdapter;
    ->createExpandButton(Landroidx/preference/PreferenceGroup;Ljava/util/List;)Landroidx/preference/ExpandButton;
...
.method private flattenPreferenceGroup(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
    ...
    .line 1
    invoke-virtual {p2}, Landroidx/preference/PreferenceGroup;
    ->sortPreferences()V
    ...
    .line 10
    .line 11
    invoke-virtual {p2, v1}, Landroidx/preference/PreferenceGroup;
    ->getPreference(I)Landroidx/preference/Preference;
    ...
    .line 19
    .line 20
    invoke-direct {v3, v2}, Landroidx/preference/PreferenceGroupAdapter$PreferenceResourceDescriptor;
    -><init>(Landroidx/preference/Preference;)V

    .line 21
    .line 22
    .line 23
    iget-object v4, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mPreferenceResourceDescriptors:Ljava/util/List;
    ...
    .line 42
    .line 43
    invoke-virtual {v3}, Landroidx/preference/PreferenceGroup;
    ->isOnSameScreenAsChildren()Z
    ...
    .line 48
    .line 49
    invoke-direct {p0, p1, v3}, Landroidx/preference/PreferenceGroupAdapter;
    ->flattenPreferenceGroup(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V

    .line 50
    .line 51
    .line 52
    :cond_1
    invoke-virtual {v2, p0}, Landroidx/preference/Preference;
    ->setOnPreferenceChangeInternalListener(Landroidx/preference/Preference$OnPreferenceChangeInternalListener;)V
...
.method public getItem(I)Landroidx/preference/Preference;
    ...
    .line 10
    :cond_0
    iget-object v0, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mVisiblePreferences:Ljava/util/List;
...
.method public getItemId(I)J
    ...
    .line 10
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/preference/PreferenceGroupAdapter;
...
.method public getItemViewType(I)I
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1}, Landroidx/preference/PreferenceGroupAdapter$PreferenceResourceDescriptor;
    -><init>(Landroidx/preference/Preference;)V

    .line 8
    .line 9
    .line 10
    iget-object p1, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mPreferenceResourceDescriptors:Ljava/util/List;
    ...
    .line 26
    iget-object v1, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mPreferenceResourceDescriptors:Ljava/util/List;
...
.method public getPreferenceAdapterPosition(Landroidx/preference/Preference;)I
    ...
    .line 5
    iget-object v2, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mVisiblePreferences:Ljava/util/List;
...
.method public onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
    ...
    .line 2
    invoke-virtual {p0, p2}, Landroidx/preference/PreferenceGroupAdapter;
    ->getItem(I)Landroidx/preference/Preference;
...
.method public bridge synthetic onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/preference/PreferenceGroupAdapter;
    ->onBindViewHolder(Landroidx/preference/PreferenceViewHolder;I)V
...
.method public onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/preference/PreferenceViewHolder;
    ...
    sget-object v3, Landroidx/preference/R$styleable;
    ->BackgroundStyle:[I

    invoke-virtual {v1, v2, v3}, Landroid/content/Context;
    ...
    ->BackgroundStyle_android_selectableItemBackground:I
    ...
    invoke-static {v2, v3}, Landroidx/appcompat/content/res/AppCompatResources;
    ...
    .line 9
    iget v1, p2, Landroidx/preference/PreferenceGroupAdapter$PreferenceResourceDescriptor;
    ->mLayoutResId:I

    const/4 v3, 0x0

    invoke-virtual {v0, v1, p1, v3}, Landroid/view/LayoutInflater;
    ...
    .line 13
    iget p2, p2, Landroidx/preference/PreferenceGroupAdapter$PreferenceResourceDescriptor;
    ->mWidgetLayoutResId:I

    if-eqz p2, :cond_2

    .line 14
    invoke-virtual {v0, p2, v1}, Landroid/view/LayoutInflater;
    ...
    .line 15
    invoke-virtual {v1, p2}, Landroid/view/View;
    ->setVisibility(I)V
    ...
    invoke-direct {p2, p1}, Landroidx/preference/PreferenceViewHolder;
...
.method public bridge synthetic onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/preference/PreferenceGroupAdapter;
    ->onCreateViewHolder(Landroid/view/ViewGroup;I)Landroidx/preference/PreferenceViewHolder;
...
.method public onPreferenceChange(Landroidx/preference/Preference;)V
    ...
    .line 9
    .line 10
    invoke-virtual {p0, v0, p1}, Landroidx/recyclerview/widget/RecyclerView$Adapter;
...
.method public updatePreferences()V
    ...
    .line 20
    invoke-virtual {v1, v2}, Landroidx/preference/Preference;
    ->setOnPreferenceChangeInternalListener(Landroidx/preference/Preference$OnPreferenceChangeInternalListener;)V
    ...
    .line 34
    .line 35
    iput-object v1, p0, Landroidx/preference/PreferenceGroupAdapter;
    ->mPreferences:Ljava/util/List;
    ...
    .line 38
    .line 39
    invoke-direct {p0, v1, v0}, Landroidx/preference/PreferenceGroupAdapter;
    ->flattenPreferenceGroup(Ljava/util/List;Landroidx/preference/PreferenceGroup;)V
    ...
    .line 45
    .line 46
    invoke-direct {p0, v1}, Landroidx/preference/PreferenceGroupAdapter;
    ->createVisiblePreferencesList(Landroidx/preference/PreferenceGroup;)Ljava/util/List;
    ...
    .line 59
    .line 60
    invoke-virtual {v2}, Landroidx/preference/PreferenceManager;
    ->getPreferenceComparisonCallback()Landroidx/preference/PreferenceManager$PreferenceComparisonCallback;
    ...
    .line 71
    .line 72
    invoke-direct {v3, p0, v0, v1, v2}, Landroidx/preference/PreferenceGroupAdapter$2;
    -><init>(Landroidx/preference/PreferenceGroupAdapter;Ljava/util/List;Ljava/util/List;Landroidx/preference/PreferenceManager$PreferenceComparisonCallback;)V

    .line 73
    .line 74
    .line 75
    invoke-static {v3}, Landroidx/recyclerview/widget/DiffUtil;
    ...
    .line 79
    invoke-virtual {v0, p0}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;
    ...
    .line 103
    .line 104
    invoke-virtual {v1}, Landroidx/preference/Preference;
    ->clearWasDetached()V
