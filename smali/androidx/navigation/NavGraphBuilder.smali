...
.method public constructor <init>(Landroidx/navigation/NavigatorProvider;II)V
    ...
    .line 3
    invoke-direct {p0, v0, p2}, Landroidx/navigation/NavDestinationBuilder;
    ...
    iput-object p2, p0, Landroidx/navigation/NavGraphBuilder;
    ->destinations:Ljava/util/List;

    .line 5
    iput-object p1, p0, Landroidx/navigation/NavGraphBuilder;
    ->provider:Landroidx/navigation/NavigatorProvider;

    .line 6
    iput p3, p0, Landroidx/navigation/NavGraphBuilder;
    ->startDestinationId:I
...
.method public constructor <init>(Landroidx/navigation/NavigatorProvider;Ljava/lang/Object;Lv1/c;Ljava/util/Map;)V
    ...
    .line 21
    invoke-direct {p0, v0, p3, p4}, Landroidx/navigation/NavDestinationBuilder;
    ...
    iput-object p3, p0, Landroidx/navigation/NavGraphBuilder;
    ->destinations:Ljava/util/List;
    ...
    .line 24
    iput-object p2, p0, Landroidx/navigation/NavGraphBuilder;
    ->startDestinationObject:Ljava/lang/Object;
...
.method public constructor <init>(Landroidx/navigation/NavigatorProvider;Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 9
    invoke-direct {p0, v0, p3}, Landroidx/navigation/NavDestinationBuilder;
...
.method public final addDestination(Landroidx/navigation/NavDestination;)V
    ...
    .line 5
    .line 6
    iget-object v0, p0, Landroidx/navigation/NavGraphBuilder;
    ->destinations:Ljava/util/List;
...
.method public build()Landroidx/navigation/NavGraph;
    ...
    .line 3
    iget-object v1, p0, Landroidx/navigation/NavGraphBuilder;
    ->destinations:Ljava/util/List;

    check-cast v1, Ljava/util/Collection;

    invoke-virtual {v0, v1}, Landroidx/navigation/NavGraph;
    ->addDestinations(Ljava/util/Collection;)V

    .line 4
    iget v1, p0, Landroidx/navigation/NavGraphBuilder;
    ->startDestinationId:I

    if-nez v1, :cond_1

    .line 5
    iget-object v2, p0, Landroidx/navigation/NavGraphBuilder;
    ->startDestinationRoute:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Landroidx/navigation/NavGraph;
    ->setStartDestination(Ljava/lang/String;)V
return-object v0
    ...
    sget-object v2, Landroidx/navigation/NavGraphBuilder$build$1$1;
    ->INSTANCE:Landroidx/navigation/NavGraphBuilder$build$1$1;

    invoke-virtual {v0, v1, v2}, Landroidx/navigation/NavGraph;
...
.method public final destination(Landroidx/navigation/NavDestinationBuilder;)V
    ...
    .line 9
    .line 10
    invoke-virtual {p1}, Landroidx/navigation/NavDestinationBuilder;
    ->build()Landroidx/navigation/NavDestination;
...
.method public final getProvider()Landroidx/navigation/NavigatorProvider;
    ...
    .line 1
    iget-object v0, p0, Landroidx/navigation/NavGraphBuilder;
    ->provider:Landroidx/navigation/NavigatorProvider;    return-object v0
.end method
...
.method public final unaryPlus(Landroidx/navigation/NavDestination;)V
    ...
    .line 5
    .line 6
    invoke-virtual {p0, p1}, Landroidx/navigation/NavGraphBuilder;
