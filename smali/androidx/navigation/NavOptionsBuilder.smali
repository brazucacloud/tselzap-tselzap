...
.method public constructor <init>()V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Landroidx/navigation/NavOptionsBuilder;
    ->builder:Landroidx/navigation/NavOptions$Builder;
    ...
    .line 12
    iput v0, p0, Landroidx/navigation/NavOptionsBuilder;
    ->popUpToId:I    
    return-void
.end method
...
.method public static synthetic popUpTo$default(Landroidx/navigation/NavOptionsBuilder;ILp1/l;ILjava/lang/Object;)V
    ...
    .line 1
    sget-object p2, Landroidx/navigation/NavOptionsBuilder$popUpTo$1;
    ->INSTANCE:Landroidx/navigation/NavOptionsBuilder$popUpTo$1;

    :cond_0
    invoke-virtual {p0, p1, p2}, Landroidx/navigation/NavOptionsBuilder;
    ->popUpTo(ILp1/l;)V
return-void
.end method
...
.method public static synthetic popUpTo$default(Landroidx/navigation/NavOptionsBuilder;Ljava/lang/Object;Lp1/l;ILjava/lang/Object;)V
    ...
    .line 6
    sget-object p2, Landroidx/navigation/NavOptionsBuilder$popUpTo$4;
    ->INSTANCE:Landroidx/navigation/NavOptionsBuilder$popUpTo$4;

    :cond_0
    invoke-virtual {p0, p1, p2}, Landroidx/navigation/NavOptionsBuilder;
    ->popUpTo(Ljava/lang/Object;Lp1/l;)V
return-void
.end method
...
.method public static synthetic popUpTo$default(Landroidx/navigation/NavOptionsBuilder;Ljava/lang/String;Lp1/l;ILjava/lang/Object;)V
    ...
    .line 2
    sget-object p2, Landroidx/navigation/NavOptionsBuilder$popUpTo$2;
    ->INSTANCE:Landroidx/navigation/NavOptionsBuilder$popUpTo$2;

    :cond_0
    invoke-virtual {p0, p1, p2}, Landroidx/navigation/NavOptionsBuilder;
    ->popUpTo(Ljava/lang/String;Lp1/l;)V
return-void
.end method
...
.method public static popUpTo$default(Landroidx/navigation/NavOptionsBuilder;Lp1/l;ILjava/lang/Object;)V
    ...
    .line 3
    sget-object p1, Landroidx/navigation/NavOptionsBuilder$popUpTo$3;
    ->INSTANCE:Landroidx/navigation/NavOptionsBuilder$popUpTo$3;
...
.method private final setPopUpToRoute(Ljava/lang/String;)V
    ...
    .line 8
    .line 9
    iput-object p1, p0, Landroidx/navigation/NavOptionsBuilder;
    ...
    .line 12
    iput-boolean p1, p0, Landroidx/navigation/NavOptionsBuilder;
    ->inclusive:Z
return-void
...
.method public final anim(Lp1/l;)V
    ...
    .line 7
    .line 8
    invoke-direct {v0}, Landroidx/navigation/AnimBuilder;
    -><init>()V
    ...
    .line 13
    .line 14
    iget-object p1, p0, Landroidx/navigation/NavOptionsBuilder;
    ->builder:Landroidx/navigation/NavOptions$Builder;

    .line 15
    .line 16
    invoke-virtual {v0}, Landroidx/navigation/AnimBuilder;
    ->getEnter()I
    ...
    .line 20
    invoke-virtual {p1, v1}, Landroidx/navigation/NavOptions$Builder;
    ...
    .line 44
    invoke-virtual {p1, v0}, Landroidx/navigation/NavOptions$Builder;
...
.method public final build$navigation_common_release()Landroidx/navigation/NavOptions;
    ...
    .line 1
    iget-object v0, p0, Landroidx/navigation/NavOptionsBuilder;
    ->builder:Landroidx/navigation/NavOptions$Builder;

    .line 2
    .line 3
    iget-boolean v1, p0, Landroidx/navigation/NavOptionsBuilder;
    ->launchSingleTop:Z
    ...
    .line 12
    .line 13
    iget-object v1, p0, Landroidx/navigation/NavOptionsBuilder;
    ->popUpToRoute:Ljava/lang/String;
    ...
    .line 16
    .line 17
    iget-boolean v2, p0, Landroidx/navigation/NavOptionsBuilder;
    ->inclusive:Z

    .line 18
    .line 19
    iget-boolean v3, p0, Landroidx/navigation/NavOptionsBuilder;
    ->saveState:Z

    .line 20
    .line 21
    invoke-virtual {v0, v1, v2, v3}, Landroidx/navigation/NavOptions$Builder;
    ...
    .line 55
    :cond_2
    iget v1, p0, Landroidx/navigation/NavOptionsBuilder;
    ->popUpToId:I
...
.method public final getLaunchSingleTop()Z
    ...
    .line 1
    iget-boolean v0, p0, Landroidx/navigation/NavOptionsBuilder;
    ->launchSingleTop:Z    return v0
.end method
...
.method public final getPopUpTo()I
    ...
    .line 1
    iget v0, p0, Landroidx/navigation/NavOptionsBuilder;
...
.method public final popUpTo(ILp1/l;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/navigation/NavOptionsBuilder;
    ->setPopUpToId$navigation_common_release(I)V

    const/4 p1, 0x0

    .line 2
    invoke-direct {p0, p1}, Landroidx/navigation/NavOptionsBuilder;
    ->setPopUpToRoute(Ljava/lang/String;)V

    .line 3
    new-instance p1, Landroidx/navigation/PopUpToBuilder;

    invoke-direct {p1}, Landroidx/navigation/PopUpToBuilder;
    -><init>()V
    ...
    .line 4
    invoke-virtual {p1}, Landroidx/navigation/PopUpToBuilder;
    ->getInclusive()Z

    move-result p2

    iput-boolean p2, p0, Landroidx/navigation/NavOptionsBuilder;
    ->inclusive:Z
...
.method public final popUpTo(Ljava/lang/Object;Lp1/l;)V
    ...
    .line 17
    invoke-direct {p0, p1}, Landroidx/navigation/NavOptionsBuilder;
    ->setPopUpToRouteObject(Ljava/lang/Object;)V
...
.method public final setPopUpTo(I)V
    ...
    .line 3
    invoke-static {p0, p1, v0, v1, v0}, Landroidx/navigation/NavOptionsBuilder;
...
.method public final setPopUpToId$navigation_common_release(I)V
    ...
    .line 1
    iput p1, p0, Landroidx/navigation/NavOptionsBuilder;
    ->popUpToId:I
