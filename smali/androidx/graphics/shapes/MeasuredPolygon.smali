...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroidx/graphics/shapes/MeasuredPolygon$Companion;
    -><init>(Lkotlin/jvm/internal/e;)V

    sput-object v0, Landroidx/graphics/shapes/MeasuredPolygon;
...
.method private constructor <init>(Landroidx/graphics/shapes/Measurer;Ljava/util/List;Ljava/util/List;Landroidx/collection/FloatList;)V
    ...
    .line 3
    invoke-virtual {p4}, Landroidx/collection/FloatList;
    ->getSize()I
    ...
    .line 6
    iput-object p1, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->measurer:Landroidx/graphics/shapes/Measurer;

    .line 7
    iput-object p2, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ...
    .line 10
    invoke-virtual {p4, v5}, Landroidx/collection/FloatList;
    ->get(I)F

    move-result v6

    invoke-virtual {p4, v0}, Landroidx/collection/FloatList;
    ->get(I)F
    ...
    invoke-direct {v6, p0, v0, v4, v7}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    -><init>(Landroidx/graphics/shapes/MeasuredPolygon;Landroidx/graphics/shapes/Cubic;FF)V

    .line 12
    invoke-interface {p1, v6}, Ljava/util/List;
    ...
    invoke-static {p2, v1, v3, v2, p3}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    ->updateProgressRange$graphics_shapes_release$default(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;FFILjava/lang/Object;)V
...
.method public synthetic constructor <init>(Landroidx/graphics/shapes/Measurer;Ljava/util/List;Ljava/util/List;Landroidx/collection/FloatList;Lkotlin/jvm/internal/e;)V
    ...
    .line 1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/graphics/shapes/MeasuredPolygon;
    -><init>(Landroidx/graphics/shapes/Measurer;Ljava/util/List;Ljava/util/List;Landroidx/collection/FloatList;)V
return-void
.end method
...
.method public static final synthetic access$getMeasurer$p(Landroidx/graphics/shapes/MeasuredPolygon;)Landroidx/graphics/shapes/Measurer;
    ...
    .line 1
    iget-object p0, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->measurer:Landroidx/graphics/shapes/Measurer;    return-object p0
.end method
...
.method public final bridge contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;
    ->contains(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)Z
...
.method public final cutAndShift(F)Landroidx/graphics/shapes/MeasuredPolygon;
    ...
    .line 22
    :cond_0
    iget-object v4, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->cubics:Ljava/util/List;
    ...
    .line 40
    .line 41
    invoke-virtual {v6}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    ->getStartOutlineProgress()F
    ...
    .line 68
    .line 69
    invoke-virtual {v4, p1}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    ...
    .line 96
    iget-object v7, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->cubics:Ljava/util/List;
    ...
    .line 104
    .line 105
    iget-object v9, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->cubics:Ljava/util/List;
    ...
    .line 114
    invoke-interface {v9, v10}, Ljava/util/List;
    ->get(I)Ljava/lang/Object;
    ...
    .line 119
    .line 120
    invoke-virtual {v9}, Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    ->getCubic()Landroidx/graphics/shapes/Cubic;
    ...
    .line 145
    .line 146
    invoke-direct {v6, v7}, Landroidx/collection/MutableFloatList;
    -><init>(I)V
    ...
    .line 179
    iget-object v10, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->cubics:Ljava/util/List;
    ...
    .line 199
    invoke-static {v9, v3}, Landroidx/graphics/shapes/Utils;
    ->positiveModulo(FF)F
    ...
    .line 203
    :goto_4
    invoke-virtual {v6, v9}, Landroidx/collection/MutableFloatList;
    ->add(F)Z
    ...
    .line 212
    .line 213
    iget-object v5, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->features:Ljava/util/List;
    ...
    .line 222
    .line 223
    iget-object v8, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->features:Ljava/util/List;

    .line 224
    .line 225
    invoke-interface {v8, v0}, Ljava/util/List;
    ->get(I)Ljava/lang/Object;
    ...
    .line 236
    invoke-static {v8, v3}, Landroidx/graphics/shapes/Utils;
    ->positiveModulo(FF)F
    ...
    .line 241
    .line 242
    invoke-interface {v9, v0}, Ljava/util/List;
    ->get(I)Ljava/lang/Object;
    ...
    .line 252
    invoke-direct {v7, v8, v9}, Landroidx/graphics/shapes/ProgressableFeature;
    -><init>(FLandroidx/graphics/shapes/Feature;)V

    .line 253
    .line 254
    .line 255
    invoke-virtual {v2, v7}, Le1/b;
    ->add(Ljava/lang/Object;)Z
    ...
    .line 265
    .line 266
    iget-object v1, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->measurer:Landroidx/graphics/shapes/Measurer;

    .line 267
    .line 268
    invoke-direct {v0, v1, p1, v4, v6}, Landroidx/graphics/shapes/MeasuredPolygon;
    -><init>(Landroidx/graphics/shapes/Measurer;Ljava/util/List;Ljava/util/List;Landroidx/collection/FloatList;)V
return-object v0
...
.method public get(I)Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
    ...
    .line 2
    iget-object v0, p0, Landroidx/graphics/shapes/MeasuredPolygon;
    ->cubics:Ljava/util/List;
...
.method public bridge synthetic get(I)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;
    ->get(I)Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;
...
.method public final bridge indexOf(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;
    ->indexOf(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)I
...
.method public final bridge lastIndexOf(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Landroidx/graphics/shapes/MeasuredPolygon;
    ->lastIndexOf(Landroidx/graphics/shapes/MeasuredPolygon$MeasuredCubic;)I
