...
.method static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Landroidx/core/content/pm/ShortcutXmlParser;
    ->GET_INSTANCE_LOCK:Ljava/lang/Object;
...
.method public static getShortcutIds(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 1
    sget-object v0, Landroidx/core/content/pm/ShortcutXmlParser;
    ->sShortcutIds:Ljava/util/ArrayList;
    ...
    .line 8
    :try_start_0
    sget-object v1, Landroidx/core/content/pm/ShortcutXmlParser;
    ->sShortcutIds:Ljava/util/ArrayList;
    ...
    .line 16
    .line 17
    sput-object v1, Landroidx/core/content/pm/ShortcutXmlParser;
    ->sShortcutIds:Ljava/util/ArrayList;
    ...
    .line 20
    .line 21
    invoke-static {p0}, Landroidx/core/content/pm/ShortcutXmlParser;
    ->parseShortcutIds(Landroid/content/Context;)Ljava/util/Set;
    ...
    :cond_1
    :goto_2
    sget-object p0, Landroidx/core/content/pm/ShortcutXmlParser;
    ->sShortcutIds:Ljava/util/ArrayList;
...
.method private static getXmlResourceParser(Landroid/content/Context;Landroid/content/pm/ActivityInfo;)Landroid/content/res/XmlResourceParser;
    ...
    .line 6
    .line 7
    invoke-virtual {p1, p0, v0}, Landroid/content/pm/PackageItemInfo;
...
.method public static parseShortcutIds(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/List;
    ...
    invoke-static {p0, v2}, Landroidx/core/content/pm/ShortcutXmlParser;
    ->getAttributeValue(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Ljava/lang/String;
...
.method private static parseShortcutIds(Landroid/content/Context;)Ljava/util/Set;
    ...
    invoke-virtual {v2, v1, v3}, Landroid/content/pm/PackageManager;
    ...
    .line 8
    iget-object v2, v2, Landroid/content/pm/ResolveInfo;
    ->activityInfo:Landroid/content/pm/ActivityInfo;

    .line 9
    iget-object v3, v2, Landroid/content/pm/ActivityInfo;
    ...
    .line 12
    :try_start_1
    invoke-static {v2}, Landroidx/core/content/pm/ShortcutXmlParser;
    ->parseShortcutIds(Lorg/xmlpull/v1/XmlPullParser;)Ljava/util/List;
    ...
    .line 13
    :try_start_2
    invoke-interface {v2}, Landroid/content/res/XmlResourceParser;
    ->close()V
    :try_end_2
