...
.method static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Landroidx/core/content/ContextCompat;
    ->sSync:Ljava/lang/Object;
...
.method public static checkSelfPermission(Landroid/content/Context;Ljava/lang/String;)I
    ...
    .line 19
    .line 20
    invoke-static {p0}, Landroidx/core/app/NotificationManagerCompat;
    ->from(Landroid/content/Context;)Landroidx/core/app/NotificationManagerCompat;
    ...
    .line 42
    invoke-virtual {p0, p1, v0, v1}, Landroid/content/Context;
...
.method public static createAttributionContext(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, Landroidx/core/content/ContextCompat$Api30Impl;
    ->createAttributionContext(Landroid/content/Context;Ljava/lang/String;)Landroid/content/Context;
...
.method public static createDeviceProtectedStorageContext(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/content/ContextCompat$Api24Impl;
...
.method private static createFilesDir(Ljava/io/File;)Ljava/io/File;
    ...
    .line 2
    .line 3
    sget-object v1, Landroidx/core/content/ContextCompat;
    ->sSync:Ljava/lang/Object;
...
.method public static getAttributionTag(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/content/ContextCompat$Api30Impl;
    ->getAttributionTag(Landroid/content/Context;)Ljava/lang/String;
...
.method public static getCodeCacheDir(Landroid/content/Context;)Ljava/io/File;
    ...
    .line 1
    invoke-static {p0}, Landroidx/core/content/ContextCompat$Api21Impl;
...
.method public static getColor(Landroid/content/Context;I)I
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, Landroidx/core/content/ContextCompat$Api23Impl;
...
.method public static getColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 9
    invoke-static {v0, p1, p0}, Landroidx/core/content/res/ResourcesCompat;
...
.method public static getContextForLanguage(Landroid/content/Context;)Landroid/content/Context;
    ...
    .line 1
    invoke-static {p0}, Landroidx/core/app/LocaleManagerCompat;
    ->getApplicationLocales(Landroid/content/Context;)Landroidx/core/os/LocaleListCompat;
    ...
    .line 29
    .line 30
    invoke-static {v1, v0}, Landroidx/core/os/ConfigurationCompat;
...
.method public static getDataDir(Landroid/content/Context;)Ljava/io/File;
    ...
    .line 21
    .line 22
    invoke-direct {v0, p0}, Ljava/io/File;
    -><init>(Ljava/lang/String;)V
...
.method public static getDisplayOrDefault(Landroid/content/Context;)Landroid/view/Display;
    ...
    .line 7
    invoke-static {p0}, Landroidx/core/content/ContextCompat$Api30Impl;
    ->getDisplayOrDefault(Landroid/content/Context;)Landroid/view/Display;
...
.method public static getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    invoke-static {p0, p1}, Landroidx/core/content/ContextCompat$Api21Impl;
...
.method public static getMainExecutor(Landroid/content/Context;)Ljava/util/concurrent/Executor;
    ...
    .line 6
    .line 7
    invoke-static {p0}, Landroidx/core/content/ContextCompat$Api28Impl;
...
.method public static getString(Landroid/content/Context;I)Ljava/lang/String;
    ...
    ->getContextForLanguage(Landroid/content/Context;)Landroid/content/Context;
...
.method public static getSystemServiceName(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/String;
    ...
    .line 12
    :cond_0
    sget-object p0, Landroidx/core/content/ContextCompat$LegacyServiceMapHolder;
    ->SERVICES:Ljava/util/HashMap;

    .line 13
    .line 14
    invoke-virtual {p0, p1}, Ljava/util/HashMap;
...
.method public static obtainAndCheckReceiverPermission(Landroid/content/Context;)Ljava/lang/String;
    ...
    .line 22
    invoke-static {p0, v0}, Landroidx/core/content/PermissionChecker;
...
.method public static registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;I)Landroid/content/Intent;
    ...
    .line 1
    invoke-static/range {v0 .. v5}, Landroidx/core/content/ContextCompat;
    ->registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
...
.method public static registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    :cond_6
    :goto_2
    sget p5, Landroid/os/Build$VERSION;
    ->SDK_INT:I
    ...
    .line 6
    invoke-static/range {v0 .. v5}, Landroidx/core/content/ContextCompat$Api33Impl;
    ->registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    .line 7
    invoke-static/range {v0 .. v5}, Landroidx/core/content/ContextCompat$Api26Impl;
    ->registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    ...
    .line 9
    invoke-virtual {v0, v1, v2, p0, v4}, Landroid/content/Context;
...
.method public static startActivities(Landroid/content/Context;[Landroid/content/Intent;)Z
    ...
    .line 1
    invoke-static {p0, p1, v0}, Landroidx/core/content/ContextCompat;
    ->startActivities(Landroid/content/Context;[Landroid/content/Intent;Landroid/os/Bundle;)Z
...
.method public static startForegroundService(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, Landroidx/core/content/ContextCompat$Api26Impl;
