...
.method public static final forEach(Landroid/util/SparseArray;Lp1/p;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 7
    .line 8
    invoke-virtual {p0, v1}, Landroid/util/SparseArray;
    ->keyAt(I)I
...
.method public static final getOrElse(Landroid/util/SparseArray;ILp1/a;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static final keyIterator(Landroid/util/SparseArray;)Ld1/y;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 2
    .line 3
    invoke-direct {v0, p0}, Landroidx/core/util/SparseArrayKt$keyIterator$1;
...
.method public static final plus(Landroid/util/SparseArray;Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    .line 12
    invoke-direct {v0, v2}, Landroid/util/SparseArray;
    -><init>(I)V

    .line 13
    .line 14
    .line 15
    invoke-static {v0, p0}, Landroidx/core/util/SparseArrayKt;
    ->putAll(Landroid/util/SparseArray;Landroid/util/SparseArray;)V

    .line 16
    .line 17
    .line 18
    invoke-static {v0, p1}, Landroidx/core/util/SparseArrayKt;
    ->putAll(Landroid/util/SparseArray;Landroid/util/SparseArray;)V
...
.method public static final set(Landroid/util/SparseArray;ILjava/lang/Object;)V
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroid/util/SparseArray;
    ->put(ILjava/lang/Object;)V
...
.method public static final valueIterator(Landroid/util/SparseArray;)Ljava/util/Iterator;
    ...
    .line 2
    .line 3
    invoke-direct {v0, p0}, Landroidx/core/util/SparseArrayKt$valueIterator$1;
    -><init>(Landroid/util/SparseArray;)V
