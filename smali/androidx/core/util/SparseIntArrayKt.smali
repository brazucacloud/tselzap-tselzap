...
.method public static final contains(Landroid/util/SparseIntArray;I)Z
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroid/util/SparseIntArray;
    ->indexOfKey(I)I
...
.method public static final forEach(Landroid/util/SparseIntArray;Lp1/p;)V
    .locals 4
...
.method public static final getOrDefault(Landroid/util/SparseIntArray;II)I
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroid/util/SparseIntArray;
    ->get(II)I
...
.method public static final getOrElse(Landroid/util/SparseIntArray;ILp1/a;)I
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final keyIterator(Landroid/util/SparseIntArray;)Ld1/y;
    .locals 1
    ...
    .line 2
    .line 3
    invoke-direct {v0, p0}, Landroidx/core/util/SparseIntArrayKt$keyIterator$1;
...
.method public static final plus(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)Landroid/util/SparseIntArray;
    ...
    .line 7
    invoke-virtual {p1}, Landroid/util/SparseIntArray;
    ->size()I
    ...
    .line 12
    invoke-direct {v0, v2}, Landroid/util/SparseIntArray;
    -><init>(I)V

    .line 13
    .line 14
    .line 15
    invoke-static {v0, p0}, Landroidx/core/util/SparseIntArrayKt;
    ->putAll(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)V

    .line 16
    .line 17
    .line 18
    invoke-static {v0, p1}, Landroidx/core/util/SparseIntArrayKt;
    ->putAll(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)V
...
.method public static final putAll(Landroid/util/SparseIntArray;Landroid/util/SparseIntArray;)V
    ...
    .line 16
    invoke-virtual {p0, v2, v3}, Landroid/util/SparseIntArray;
    ->put(II)V
...
.method public static final valueIterator(Landroid/util/SparseIntArray;)Ld1/y;
    .locals 1
    ...
    .line 2
    .line 3
    invoke-direct {v0, p0}, Landroidx/core/util/SparseIntArrayKt$valueIterator$1;
    -><init>(Landroid/util/SparseIntArray;)V
