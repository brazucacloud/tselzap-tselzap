...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;LQ1/n;Lokhttp3/MediaType;JILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 4
    :cond_1
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/ResponseBody$Companion;->create(LQ1/n;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public static synthetic create$default(Lokhttp3/ResponseBody$Companion;LQ1/o;Lokhttp3/MediaType;ILjava/lang/Object;)Lokhttp3/ResponseBody;
    .locals 0
    ...
    .line 3
    :cond_0
    invoke-virtual {p0, p1, p2}, Lokhttp3/ResponseBody$Companion;->create(LQ1/o;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
...
# virtual methods
.method public final create(LQ1/n;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
    .locals 1
    ...
    invoke-direct {v0, p2, p3, p4, p1}, Lokhttp3/ResponseBody$Companion$asResponseBody$1;-><init>(Lokhttp3/MediaType;JLQ1/n;)V

    return-object v0
.end method

.method public final create(LQ1/o;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    .locals 3
    ...
    .line 19
    invoke-virtual {p0, v0, p2, v1, v2}, Lokhttp3/ResponseBody$Companion;->create(LQ1/n;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Ljava/lang/String;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
    ...
    .line 8
    invoke-virtual {v1, p1, v2, v3, v0}, LQ1/l;->Z(Ljava/lang/String;IILjava/nio/charset/Charset;)V

    .line 9
    iget-wide v2, v1, LQ1/l;->c:J

    .line 10
    invoke-virtual {p0, v1, p2, v2, v3}, Lokhttp3/ResponseBody$Companion;->create(LQ1/n;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;JLQ1/n;)Lokhttp3/ResponseBody;
    .locals 1
    ...
    .line 24
    invoke-virtual {p0, p4, p1, p2, p3}, Lokhttp3/ResponseBody$Companion;->create(LQ1/n;Lokhttp3/MediaType;J)Lokhttp3/ResponseBody;
...
.method public final create(Lokhttp3/MediaType;LQ1/o;)Lokhttp3/ResponseBody;
    .locals 1
    ...
    .line 23
    invoke-virtual {p0, p2, p1}, Lokhttp3/ResponseBody$Companion;->create(LQ1/o;Lokhttp3/MediaType;)Lokhttp3/ResponseBody;
...
.method public final create([BLokhttp3/MediaType;)Lokhttp3/ResponseBody;
    ...
    .line 13
    invoke-virtual {v0, p1}, LQ1/l;->R([B)V
